...
* User addition/deletion and permission changes, as well as user login events are only written to the parent/reporting account ID of your New Relic organization.
...
<Collapser
  ...
  >
    Login events are only written to the parent/reporting account ID of your New Relic organization. To query users who logged into your organization, use a query similar to the following:
